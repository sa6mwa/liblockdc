...
function(lockdc_copy_required_license package_name destination_dir)
    ...
    message(FATAL_ERROR
        "missing required ${package_name} dev license; looked in:\n  ${candidate_list}")
endfunction()
...
set(package_root "${LOCKDC_BINARY_DIR}/package/dev")
...
file(COPY "${LOCKDC_EXTERNAL_ROOT}/pslog-static/install/include/pslog.h" DESTINATION "${package_root}/include")
file(COPY "${LOCKDC_EXTERNAL_ROOT}/pslog-static/install/include/pslog_version.h" DESTINATION "${package_root}/include")
...
file(COPY "${LOCKDC_ROOT}/LICENSE" DESTINATION "${package_root}/share/doc/liblockdc")
file(COPY "${LOCKDC_ROOT}/README.md" DESTINATION "${package_root}/share/doc/liblockdc")
...
set(archive_base "${LOCKDC_DIST_DIR}/liblockdc-${LOCKDC_VERSION}-${LOCKDC_TARGET_ID}-dev.tar")
...
if(NOT tar_result EQUAL 0)
    message(FATAL_ERROR "failed to create dev archive")
endif()
file(REMOVE "${archive}")
execute_process(
