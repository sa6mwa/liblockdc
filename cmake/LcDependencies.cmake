...
function(lc_get_lonejson_asset_info out_name out_hash)
  ...
  if(asset_name STREQUAL "liblonejson-0.14.1-x86_64-linux-gnu.tar.gz")
    set(asset_hash "d0213e2613799037637cbad6432ae78444c6106614bb665230c56cecdae98193")
  elseif(asset_name STREQUAL "liblonejson-0.14.1-x86_64-linux-musl.tar.gz")
    set(asset_hash "5570b1b7c9773e97fd3cd97d22d0af45513559ff0ac2bd92c0dcfc0588ae6aba")
  elseif(asset_name STREQUAL "liblonejson-0.14.1-aarch64-linux-gnu.tar.gz")
    set(asset_hash "559cfbb0d2651b22579baf57c6eab1e24a62de4da5ef088d9c7d8742a98a2704")
  elseif(asset_name STREQUAL "liblonejson-0.14.1-aarch64-linux-musl.tar.gz")
    set(asset_hash "2486ee6c968c8ebc8b45c7428ecf911bb93f6d194c635b472a9bfda1ba4890db")
  elseif(asset_name STREQUAL "liblonejson-0.14.1-armhf-linux-gnu.tar.gz")
    set(asset_hash "205023e4368255e980c97e0d8da86848c5e9dea8e5ce87e7ffb5581ac817d352")
  elseif(asset_name STREQUAL "liblonejson-0.14.1-armhf-linux-musl.tar.gz")
    set(asset_hash "8c808f6755d997c26a126ef3e61fd0f2ac4371e34f64a25a7ff2fc569e882a52")
  elseif(asset_name STREQUAL "liblonejson-0.14.1-arm64-apple-darwin.tar.gz")
    set(asset_hash "c45619350e18bf5759017ce6946dba7150785a5bbdd7f9178fbda5c735da725e")
  else()
