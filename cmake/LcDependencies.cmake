...
function(lc_get_pslog_asset_info out_name out_hash shared_flag)
  if(shared_flag)
    set(asset_suffix "${LOCKDC_TARGET_ID}.tar.gz")
  else()
    set(asset_suffix "${LOCKDC_TARGET_ID}-dev.tar.gz")
  endif()
  set(asset_name "libpslog-${LOCKDC_PSLOG_VERSION}-${asset_suffix}")

  if(asset_name STREQUAL "libpslog-0.1.0-x86_64-linux-gnu.tar.gz")
    set(asset_hash "40075cf865e55c37ceec71b9bae107c783d0a364f544e01f25686ad212f2ac10")
  elseif(asset_name STREQUAL "libpslog-0.1.0-x86_64-linux-gnu-dev.tar.gz")
    set(asset_hash "326fe7c021c9d858e6bbd5822e18d1da106e0bb7503114c0fc9a2801bdce24cc")
  elseif(asset_name STREQUAL "libpslog-0.1.0-x86_64-linux-musl.tar.gz")
    set(asset_hash "a323f49e524b6995d8d4a779ac91f5942176666d1c75e148abbbfe38f2ea467a")
  elseif(asset_name STREQUAL "libpslog-0.1.0-x86_64-linux-musl-dev.tar.gz")
    set(asset_hash "eaa6edc49b874da9ac884566b82b8fab4d3bb60aac5cd0929747ed1b3d7db067")
  elseif(asset_name STREQUAL "libpslog-0.1.0-aarch64-linux-gnu.tar.gz")
    set(asset_hash "efa101f12f99b475fb356544e4bdb2a3225cdda0b5131d49b9e0fb55530b48c8")
  elseif(asset_name STREQUAL "libpslog-0.1.0-aarch64-linux-gnu-dev.tar.gz")
    set(asset_hash "004509a1f44e40896f9323f5bf76a63ec97234d0e3bb255537bee4aad11dc987")
  elseif(asset_name STREQUAL "libpslog-0.1.0-aarch64-linux-musl.tar.gz")
    set(asset_hash "ce707fc3a949584721230e75107c121aa46372f47e825319bc545ca5a7f16195")
  elseif(asset_name STREQUAL "libpslog-0.1.0-aarch64-linux-musl-dev.tar.gz")
    set(asset_hash "b01266faa7b355de9d0155851a8460a1f3c3bdaa1d7df12ebb42882073ec12f2")
  elseif(asset_name STREQUAL "libpslog-0.1.0-armhf-linux-gnu.tar.gz")
    set(asset_hash "9f21b073d8352992bc79cf7d16e528506aab89e67f2536c4f8b704adb26394ad")
  elseif(asset_name STREQUAL "libpslog-0.1.0-armhf-linux-gnu-dev.tar.gz")
    set(asset_hash "303e2006637dbedf0ce4308ac3cf7a84551adc713cc2d81d2851dbb6adcc83ac")
  elseif(asset_name STREQUAL "libpslog-0.1.0-armhf-linux-musl.tar.gz")
    set(asset_hash "0e80cef1c473449ac79327997f0fa633feb3967f46d1085aa39a8d49357bad39")
  elseif(asset_name STREQUAL "libpslog-0.1.0-armhf-linux-musl-dev.tar.gz")
    set(asset_hash "61bbf0fe15cac54be0d0056632713268e9202bb2596cc069c1687e6fd356dd7e")
  else()
...
function(lc_add_pslog variant shared_flag)
  ...
  if(shared_flag)
    set(lib_type SHARED)
    set(imported_location "${install_dir}/lib/libpslog${CMAKE_SHARED_LIBRARY_SUFFIX}.0.1.0")
  else()
    set(lib_type STATIC)
