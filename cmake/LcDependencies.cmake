...
function(lc_get_pslog_asset_info out_name out_hash shared_flag)
  ...
  if(asset_name STREQUAL "libpslog-0.3.0-x86_64-linux-gnu.tar.gz")
    set(asset_hash "f07c8f52173ce1947a5cc1dbf4d420edb7e8e6b129087e61264993027575b28d")
  elseif(asset_name STREQUAL "libpslog-0.3.0-x86_64-linux-musl.tar.gz")
    set(asset_hash "bc3bbec73544512aa246aa29fb9eaf9350e9ee8e0d317b4e4ad12aefd0e8b17a")
  elseif(asset_name STREQUAL "libpslog-0.3.0-aarch64-linux-gnu.tar.gz")
    set(asset_hash "2432b84b322aaff22bfb27f85f6f4c5a5f4225d29a971aed98669978c0d335dc")
  elseif(asset_name STREQUAL "libpslog-0.3.0-aarch64-linux-musl.tar.gz")
    set(asset_hash "613a6f047a981c47d935f32ea540a068d53903087e88cbd9687183ad16840b7c")
  elseif(asset_name STREQUAL "libpslog-0.3.0-armhf-linux-gnu.tar.gz")
    set(asset_hash "e7de638336919964e8a768f75b124fa4901a964ccfd80b932e1a81beec0b7648")
  elseif(asset_name STREQUAL "libpslog-0.3.0-armhf-linux-musl.tar.gz")
    set(asset_hash "2c5d4597d411a7ac92f2612dcc1719ffb2dc10b10b7251797e31cddcf8609506")
  else()
