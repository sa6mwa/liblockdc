...
function(lc_get_pslog_asset_info out_name out_hash)
  ...
  if(asset_name STREQUAL "libpslog-0.8.0-x86_64-linux-gnu.tar.gz")
    set(asset_hash "97e93d954dd34a8264eeb99b6c4f276d69b1256ebb193326fbab173e9d11e7f5")
  elseif(asset_name STREQUAL "libpslog-0.8.0-x86_64-linux-musl.tar.gz")
    set(asset_hash "1570887b6c7a604122356977e914b28868948de3c4daa8e8bbc771bf8fce58f8")
  elseif(asset_name STREQUAL "libpslog-0.8.0-aarch64-linux-gnu.tar.gz")
    set(asset_hash "48e5aeae9a37f2b47cd92cff08649743ba47333393b4514390a7e28bc4077360")
  elseif(asset_name STREQUAL "libpslog-0.8.0-aarch64-linux-musl.tar.gz")
    set(asset_hash "10dc6b81aac50f635b329172f7e7fbb7180de79df09fb5395d601ab584ad5150")
  elseif(asset_name STREQUAL "libpslog-0.8.0-armhf-linux-gnu.tar.gz")
    set(asset_hash "ffac626a6044c2165c0fa550aae6c0cd838ed90a5561e7cc9dee2540c8fd52f7")
  elseif(asset_name STREQUAL "libpslog-0.8.0-armhf-linux-musl.tar.gz")
    set(asset_hash "fcddcfb65ca0328c6babee6ec577eff0cd20380f77edb182f919253fc97e35b7")
  elseif(asset_name STREQUAL "libpslog-0.8.0-arm64-apple-darwin.tar.gz")
    set(asset_hash "f74b3687ec6e5c56d17e90eb0d70424e07920157f3a81fa9e06df53c1b7aea15")
  else()
