...
POUCH_GO_ACCEPTANCE_BENCH ?= MediumLQL(Documents|Keys)/Docs4096/(index|scan)/(EqSparse|RangeHalf|InTags|ContainsMessage)
POUCH_GO_ACCEPTANCE_BENCHTIME ?= 1x
POUCH_GO_ACCEPTANCE_SEED_ROWS ?= 64
POUCH_GO_ACCEPTANCE_SCALE_ROWS ?= 4096
POUCH_GO_ACCEPTANCE_SCALE_SCENARIOS ?= EqSparse,RangeHalf,InTags,ContainsMessage
