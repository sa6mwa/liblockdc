...
function(assert_archive_layout archive_path kind version target_id shared_lib_name shared_soname shared_link_name)
    ...
    elseif(kind STREQUAL "dev")
        ...
        message(FATAL_ERROR "unknown archive kind: ${kind}")
    endif()
