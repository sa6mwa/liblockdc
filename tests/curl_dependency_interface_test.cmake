...
string(FIND "${curl_static_libs}" "-lz" curl_static_libs_zlib_pos)
if(curl_static_libs_zlib_pos EQUAL -1)
    message(FATAL_ERROR "curl dependency metadata is missing zlib link flags in curl-config --static-libs")
endif()
