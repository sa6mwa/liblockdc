...
assert_not_contains("${curl_static_pc_text}" "libssh2" "libssh2 dependency in static libcurl.pc")
assert_not_contains("${curl_shared_pc_text}" "libssh2" "libssh2 dependency in shared libcurl.pc")
assert_not_contains("${curl_static_libs}" "ssh2" "libssh2 link flags in curl-config --static-libs")
assert_not_contains("${curl_protocols}" "SCP" "SCP protocol support")
assert_not_contains("${curl_protocols}" "SFTP" "SFTP protocol support")
