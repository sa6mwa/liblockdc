...
assert_contains(root_makefile "worst-case-scenario:" "standalone worst-case diagnostic target")
assert_contains(root_makefile "WORST_CASE_TIMEOUT ?= 30m" "worst-case bounded wall-clock budget")
assert_not_contains(root_makefile "__prerelease-hardening: __prerelease __bench-gate __pouch-core-hardening __benchmark-outbox-hardening __worst-case-scenario" "worst-case target excluded from prerelease hardening")
