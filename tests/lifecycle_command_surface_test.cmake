...
assert_contains(root_makefile "$(TIMED) 'finalize-slice format' $(MAKE) __format" "ordinary slice format timing")
assert_contains(root_makefile "$(TIMED) 'finalize-slice test-debug' $(MAKE) __test-debug" "ordinary slice test timing")
...
assert_contains(root_makefile "$(TIMED) 'prerelease finalize-slice' $(MAKE) __finalize-slice" "ordinary prerelease slice timing")
assert_contains(root_makefile "$(TIMED) 'prerelease valgrind' $(MAKE) __valgrind" "ordinary prerelease Valgrind timing")
assert_contains(root_makefile "$(TIMED) 'prerelease fuzz-smoke' $(MAKE) __fuzz-smoke" "ordinary prerelease fuzz timing")
assert_contains(root_makefile "$(TIMED) 'prerelease e2e' $(MAKE) __test-e2e" "ordinary prerelease e2e timing")
assert_contains(root_makefile "$(TIMED) 'prerelease bench-gate' $(MAKE) __bench-gate" "ordinary prerelease benchmark timing")
assert_contains(root_makefile "__prerelease: __prerelease-ordinary" "deterministic prerelease graph")
assert_contains(root_makefile "$(TIMED) 'bench-gate benchmarks' $(MAKE) __benchmarks" "benchmark suite timing")
assert_contains(root_makefile "$(TIMED) 'bench-gate perf-gate' $(MAKE) __perf-gate" "performance gate timing")
assert_contains(root_makefile "$(TIMED) 'perf-gate pouch-go-parity' $(MAKE) __benchmark-pouch-go-parity-gate" "default parity benchmark timing")
assert_contains(root_makefile "$(TIMED) 'perf-gate pouch-go-durable-parity' $(MAKE) __benchmark-pouch-go-durable-gate" "durable parity benchmark timing")
