...
if(NOT package_result EQUAL 0)
    message(FATAL_ERROR
        "expected runtime packaging with install-tree licenses to succeed\n"
        "stdout:\n${package_stdout}\n"
        "stderr:\n${package_stderr}")
endif()
...
if(NOT tar_result EQUAL 0)
    message(FATAL_ERROR
        "failed to list runtime archive contents\n"
        "stderr:\n${tar_stderr}")
endif()
...
function(assert_archive_contains pattern description)
    if(NOT archive_listing MATCHES "${pattern}")
        message(FATAL_ERROR
            "expected runtime archive to contain ${description}\n"
            "archive contents:\n${archive_listing}")
    endif()
endfunction()
